                ...
                <div id="carouselExampleCaptions" className="carousel slide" data-ride="carousel">
                    ...
                    <div className="carousel-inner" >
                        <div className="carousel-item active col-lg-12" data-interval="2000">
                            <a target="_blank" href="https://shareazc.github.io/open-house-organa/#/" ><img src="https://fotos.subefotos.com/e99ef11b5288d8fb6226514902509bc7o.png" className="d-block w-100 img col-lg-6" alt="..."/></a>
                            <div className="container col-md-6">
                                <div className="card col-lg-12 card-color card-form d-md-block">
                        ...
                        <div className="carousel-item col-lg-12" data-interval="2000">
                            <a target="_blank" href="https://angieeca06.github.io/GDL002-burger-queen/#/" ><img src="https://fotos.subefotos.com/db20387c79ad521227d48addc60cfb11o.png" className="d-block col-lg-6 img w-100 " alt="..."/></a>
                        ...
                        <div className="carousel-item col-lg-12" data-interval="2000">
                            <a target="_blank" href="https://angieeca06.github.io/gdl-2019-01-bc-core-cipher/src/" ><img src="https://fotos.subefotos.com/c7a3870b38c50a2857685f60f16b7326o.png" className="d-block col-lg-6 img w-100" alt="..."/></a>
                            <div className="container col-lg-6">
                                <div className="card col-lg-12 card-color card-form  d-md-block">
                        ...
                        <div className="carousel-item col-lg-12" data-interval="2000">
                            <a target="_blank" href="https://angieeca06.github.io/GDL002-framework-social-network/#/" ><img src="https://fotos.subefotos.com/1c449586547d64d7455684d7348f3bd8o.png" className="d-block col-lg-8 img w-100 image-fluid" title="Haz click para ver demo" alt="..."/></a>
